...
TELEGRAM_BOT_TOKEN = os.getenv("TELEGRAM_BOT_TOKEN", "8614741199:AAHww1iib_RTewHBAunAHATDdZOCPCQKFpo")
...
# Gemini AI — dùng để xác nhận và nâng cao chất lượng tín hiệu
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyBaf8waqobzJWVUFKdOea8ENH2JTHjvY-s")
